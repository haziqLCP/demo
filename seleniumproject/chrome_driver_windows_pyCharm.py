...
#
#         #click cancel button
#         # self.driver.find_element_by_css_selector('body.modal-open:nth-child(2) div.wrapper:nth-child(1) div.modal.fade.show:nth-child(7) div.modal-dialog.modal-dialog-centered div.modal-content div.modal-footer > button.btn.btn-secondary:nth-child(1)').click()
#
